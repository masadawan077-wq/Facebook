...
public class Main {
    ...
    public static User Find_Friend_ByNAME(String name) {
        ...
        for (String username : friends) {
            ...
            if (temp.getFirstname().equalsIgnoreCase(name) || temp.getLastname().equalsIgnoreCase(name) || fullname.equalsIgnoreCase(name)) {
                matches.add(temp);
            }
        }
    ...
    public static void Password_change() {
        ...
        if (Username_Already_Exists(u)) {
            ...
            if (temp.getFirstname().equalsIgnoreCase(f_n) && temp.getLastname().equalsIgnoreCase(l_n) && temp.getBirth().equals(date)) {
